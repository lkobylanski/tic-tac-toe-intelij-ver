...
public class TicTacToeMatch {
    ...
    public void makeAMove(String[][] currentBoard) {
        ...
        System.out.println();
        System.out.printf(
                "Payer %s is making a move. Note: Please first enter a row number in range 1 - 3 then do the same for the columns. Remember you can only select empty fields.%n",
                this.currentPlayer
        );
